...
class Student(models.Model):
    ...
    stu_entrance_time = models.DateField(max_length=32, null=False, help_text='入学日期', default='2019-09')
    stu_graduation_time = models.DateField(max_length=32, null=False, help_text='毕业日期', default='2021-07')
