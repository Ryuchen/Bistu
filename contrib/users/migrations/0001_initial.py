...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='唯一标识ID', primary_key=True, serialize=False, unique=True)),
                ('stu_number', models.IntegerField(default='001', help_text='学号', unique=True)),
                ...
                ('stu_cultivating_mode', models.CharField(choices=[('C1', '专业学位')], default='C1', help_text='培养方式', max_length=128)),
                ('stu_enrollment_category', models.CharField(choices=[('E1', '定向'), ('E2', '非定向')], default='E1', help_text='录取类别', max_length=64)),
                ('stu_natioanlity', models.CharField(default='中国', help_text='国籍', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education', models.OneToOneField(help_text='学历', null=True, on_delete=True, related_name='education', to='users.Education')),
