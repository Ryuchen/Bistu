    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stu_birth_day', models.CharField(default='201909', help_text='出生日期', max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, help_text='唯一标识ID', primary_key=True, serialize=False, unique=True)),
                ('tut_birth_day', models.CharField(help_text='出生日期', max_length=128, null=True)),
                ('tut_entry_day', models.CharField(help_text='入职日期', max_length=128, null=True)),
