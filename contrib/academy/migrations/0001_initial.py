    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aca_avatar', models.ImageField(help_text='学院图标', upload_to='')),
                ...
                ('aca_user', models.ForeignKey(help_text='学院负责人', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '学院',
