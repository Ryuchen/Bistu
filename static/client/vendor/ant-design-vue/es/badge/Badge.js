...
export default {
  ...
  methods: {
    ...
    getBadgeClassName: function getBadgeClassName(prefixCls) {
      ...
      return classNames(prefixCls, (_classNames = {}, _defineProperty(_classNames, prefixCls + '-status', this.hasStatus()), _defineProperty(_classNames, prefixCls + '-not-a-wrapper', !children.length), _classNames));
    },
