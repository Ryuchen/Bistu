...
exports['default'] = {
  ...
  methods: {
    ...
    getBadgeClassName: function getBadgeClassName(prefixCls) {
      ...
      return (0, _classnames2['default'])(prefixCls, (_classNames = {}, (0, _defineProperty3['default'])(_classNames, prefixCls + '-status', this.hasStatus()), (0, _defineProperty3['default'])(_classNames, prefixCls + '-not-a-wrapper', !children.length), _classNames));
    },
